# Sage Wordpress theme by Roots but with Vue.js added along with Bootstrap 4

The normal yarn commands included will now compile vuejs as well.

You can add Vue component files in resources/assets/scripts/vue folder.
